...
public class Kitchen extends MultiBlockMachine {
    ...
    public Kitchen(ExoticGarden plugin, ItemGroup itemGroup) {
        super(itemGroup, new SlimefunItemStack("KITCHEN", Material.CAULDRON, "&eCucina", "", "&a&oQui puoi preparare tante prelibatezze!", "&a&oIl risultato appare nello slot di uscita della fornace"), new ItemStack[] { new CustomItemStack(Material.BRICK_STAIRS, "&oScale di mattoni (capovolte)"), new CustomItemStack(Material.BRICK_STAIRS, "&oScale di mattoni (capovolte)"), new ItemStack(Material.BRICKS), new ItemStack(Material.STONE_PRESSURE_PLATE), new ItemStack(Material.IRON_TRAPDOOR), new ItemStack(Material.BOOKSHELF), new ItemStack(Material.FURNACE), new ItemStack(Material.DISPENSER), new ItemStack(Material.CRAFTING_TABLE) }, new ItemStack[0], BlockFace.SELF);
